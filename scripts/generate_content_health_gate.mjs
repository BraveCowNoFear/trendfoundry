...
const publicDocs = [
  ...
  "docs/content-experiments.md",
  "docs/content-send-batch.md",
  ...
  "docs/content-outreach-followups.md",
  "docs/content-outreach-export.md",
  "docs/content-outreach-routes.md",
  "docs/content-ops.md",
...
const privateFiles = [
  ...
  "dist/content-attribution/attribution-ledger.csv",
  "dist/content-attribution/attribution-ledger.md",
  "dist/content-experiments/experiments.csv",
  "dist/content-experiments/experiment-plan.md",
  "dist/content-send-batch/send-batch.csv",
  "dist/content-send-batch/send-batch.md",
  ...
  "dist/content-outreach-followups/followups.csv",
  "dist/content-outreach-followups/followups.md",
  "dist/content-outreach-export/drafts.csv",
  "dist/content-outreach-export/drafts.md",
  "dist/content-outreach-routes/routes.csv",
  "dist/content-outreach-routes/routes.md",
...
const sourceFiles = [
  ...
  "scripts/generate_content_attribution.mjs",
  "scripts/generate_content_experiments.mjs",
  "scripts/generate_content_send_batch.mjs",
  ...
  "scripts/generate_content_outreach_followups.mjs",
  "scripts/export_content_outreach_drafts.mjs",
  "scripts/discover_content_outreach_routes.mjs",
  "scripts/complete_content_outreach_send.mjs",
  "scripts/intake_content_replies.mjs",
  "scripts/generate_content_outreach_review.mjs",
