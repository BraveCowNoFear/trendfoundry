...
async function checkLocal() {
  ...
  assertCheck("Chinese landing page keeps product rules and samples clear", zhIndex.includes("按你需要决策的频率选档。") && zhIndex.includes("三条信号，够你判断质量。") && zhIndex.includes("打开完整 12 条"));
