# TrendFoundry Issue 2026-06-08

Generated: 2026-06-08T17:50:16.053Z
...
### 6. Best AI Video Prompt Generator 2026 (FREE)
...
### 7. B站强推！这几位老师简直就是教 AI 漫剧的神！！！

- Score: 135
- Source: bilibili / B站AI工作流
- Fit: high
- Quality: normal
- Link: http://www.bilibili.com/video/av116713756562539
- Hook: 验证方法是否可复现，避免照搬原视频。
- Demo angle: Pick one promised technique and reproduce it with a tiny input instead of summarizing the full video.
- Limitation: Platform popularity is not proof of quality; validate the workflow before recommending it.

### 8. 【赛博古董】21年前 YouTube 被上传的第一个视频
...
### 9. 10K 星的 AI 虚拟人框架：把聊天框变成能说话的 Live2D 角色

- Score: 124
- Source: bilibili / 开源AI项目
- Fit: high
- Quality: normal
- Link: http://www.bilibili.com/video/av116712766704983
- Hook: 验证方法是否可复现，避免照搬原视频。
- Demo angle: Pick one promised technique and reproduce it with a tiny input instead of summarizing the full video.
- Limitation: Platform popularity is not proof of quality; validate the workflow before recommending it.

### 10. Show HN: Lathe – Use LLMs to learn a new domain, not skip past it
...
### 12. Counterintuitive problems in discrete probability

- Score: 80
- Source: arxiv / creator economy generative AI
- Fit: medium
- Quality: normal
- Link: http://arxiv.org/abs/2606.07516v1
- Hook: 验证来源、证据和可讲边界。
