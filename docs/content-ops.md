...
Generated: 2026-06-08T08:37:07.881Z
...
- Health gate: 57 files checked, 0 with mojibake markers, 0 public prospect leaks
...
17. Review `docs/content-health-gate.md` before trusting console-rendered Chinese text.
18. If approved, use `dist/buyer-content-pack/delivery-email.md` as the human-reviewed send draft.
19. If the buyer requests a custom niche, run `npm run custom-proof-pack -- --niche="..." --platform="..." --buyer="..." --channel="..."`.
