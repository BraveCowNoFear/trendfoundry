...
- content sales lane status: content ops steps, primary episode, buyer deliverables, evidence items/claims, delivery gate pass/fail counts, prospects, CRM due today, close queue, outreach review packs, deal desk active deals, objection playbook rows, and content health gate counts
- lead stage counts
